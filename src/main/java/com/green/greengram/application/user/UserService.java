...
//        }
        ...
        List<EnumUserRole> roles = user.getUserRoles().stream().map(item -> item.getId().getRoleCode()).toList();
    ...
    public Map<Long, UserGetItem> getUserList(List<Long> writerUserIdList) {
